      ...
      <section className="work-section shell section-pad" id="work">
        ...
        <div className="project-list">
          <Link href="/work/ai-agent" className="project-card" data-analytics-event="case_open_ai_agent">
            <div className="project-copy"><div><span className="project-no">01</span><span className="tag">AI PRODUCT</span></div><h2>Google Business Profile AI Agent</h2><p>With one week to design, I scoped the agent's first useful loop, made completed work visible, and documented the controls the MVP deferred.</p><span className="role-line">Semrush · MVP launched in 2025<br/>Sole Product Designer</span><span className="text-link">Read case study <b aria-hidden="true">↗</b></span></div>
          ...
          <Link href="/work/semrush-locations" className="project-card" data-analytics-event="case_open_semrush_locations">
            <div className="project-copy"><div><span className="project-no">03</span><span className="tag">LOCAL SEO</span></div><h2>Semrush Locations Expansion</h2><p>I moved known Google Business Profile opportunities into the Locations list and replaced repeated setup with one bulk action.</p><span className="role-line">Semrush · Bulk release 2025<br/>Sole Product Designer</span><span className="text-link">Read case study <b aria-hidden="true">↗</b></span></div>
