...
export default function RaiffeisenMobileCaseStudy() {
  return <main id="main-content" className="case-page qr-case">
    <header className="case-hero shell">
      <div className="case-meta"><span>Raiffeisen Bank · 2022</span><span>Mobile banking</span><span>Sole Product Designer</span></div>
    ...
    <Decision no="01" title="Rename the system around the user’s task" eyebrow="Language as product design">
      ...
      <EvidenceVisual src="/work/raiffeisen-mobile/one-time-qr-creation.jpg" alt="One-time QR creation flow, including type selection, form states, validation and the created QR" caption="One-time QR creation · final flow and edge states" portrait />
    </Decision>
    ...
    <Decision no="02" title="Replace a defaulted tab with an explained choice" eyebrow="Choice architecture" tone>
      ...
      <div className="chooser-compare"><div><span>Before</span><div className="fake-tabs"><b>Dynamic</b><b>Static</b></div><small>A technical default, selected in advance</small></div><div><span>After</span><ul><li><b>One-time</b><small>One payment</small></li><li><b>Reusable</b><small>Same-price payments</small></li><li><b>Cashier</b><small>Changing totals</small></li></ul></div></div>
      <EvidenceVisual src="/work/raiffeisen-mobile/reusable-qr-creation.jpg" alt="Reusable QR creation flow with naming, optional amount and resulting QR details" caption="Reusable QR · create once, optionally set an amount" />
      <EvidenceVisual src="/work/raiffeisen-mobile/reusable-qr-usage.jpg" alt="Reusable QR management flow with showing, sharing, renaming and viewing related transactions" caption="Reusable QR · show, share, rename and trace payments" />
    </Decision>
    ...
    <Decision no="03" title="Give cashiers the payment tools—not the owner’s bank" eyebrow="Delegated access">
      ...
      <EvidenceVisual src="/work/raiffeisen-mobile/cashier-qr-creation.jpg" alt="Cashier QR creation flow with naming, validation and the empty transaction state" caption="Cashier QR · constrained setup for a delegated payment role" />
    </Decision>
    ...
    <Link className="next-project shell" href="/work/ai-agent"><span>Next case</span><b>Making invisible AI work visible</b><i>AI Agent ↗</i></Link>
  </main>;
}
