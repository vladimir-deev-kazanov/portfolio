...
export default function RaiffeisenMobileCaseStudy() {
  return <main id="main-content" className="case-page qr-case">
    ...
    <section className="reflection shell"><p className="kicker">Reflection</p><h2>Technical accuracy does not guarantee user understanding.</h2><div className="reflection-copy">
