...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Vladimir Deev-Kazanov — Product Designer", description: "I make complex products feel obvious.", images: [{ url: "/og.png", width: 1200, height: 630 }] },
  twitter: { card: "summary_large_image", title: "Vladimir Deev-Kazanov — Product Designer", description: "I make complex products feel obvious.", images: ["/og.png"] },
};
